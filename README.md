...
FANZAブックスのコミック・BL・TL・読み放題に対応したアフィリエイト商品サイトです。[PinkClub-FANZA](https://github.com/TaniyanR/PinkClub-FANZA) を基盤に、対象商品とAPI取得先を分離しています。
...
4区分をcron実行ごとに巡回し、取得位置を区分別に保持します。
