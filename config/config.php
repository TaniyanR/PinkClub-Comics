...
if (!defined('APP_NAME')) {
    define('APP_NAME', 'PinkClub Comics');
}
if (!defined('BASE_URL')) {
...
return [
    'db' => $dbConfig,
    'security' => [
        'session_name' => 'pinkclub_comics_session',
    ],
    'dmm' => [
        ...
        'master_floor_id' => '43',
        'catalog_targets' => [
            ['site' => 'FANZA', 'service' => 'ebook', 'floor' => 'comic', 'label' => 'コミック'],
            ['site' => 'FANZA', 'service' => 'ebook', 'floor' => 'bl', 'label' => 'BL'],
            ['site' => 'FANZA', 'service' => 'ebook', 'floor' => 'tl', 'label' => 'TL'],
            ['site' => 'FANZA', 'service' => 'ebook', 'floor' => 'unlimited', 'label' => '読み放題'],
        ],
    ],
    'pagination' => [
        'per_page' => 32,
